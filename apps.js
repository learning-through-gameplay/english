apps =  {
      ...
      items: [
        ...
        {icon: 'format_shapes', name:'אותיות נופלות', type: 'app', appType: 'falling_answers', listName: 'ABC', questionIndex: 'audio', resultIndex:'englishUpperCase', setItems: 5, title:'אותיות נופלות'},
      ]
    };
