apps =  {
      ...
      type: 'menu',
      items: [
        {icon: 'volume_up', name:'אותיות גדולות', type: 'app', appType: 'mcq', listName: 'ABC', questionIndex: 'audio', resultIndex: 'englishUpperCase' },
        {icon: 'volume_up', name:'אותיות קטנות', type: 'app', appType: 'mcq', listName: 'ABC', questionIndex: 'audio', resultIndex: 'englishLowerCase' },
